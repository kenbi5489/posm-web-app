                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {(acceptance?.image1 || item.image1) ? (
                      <div className="space-y-3">
                          <a href={acceptance?.image1 || item.image1} target="_blank" rel="noreferrer" className="w-full bg-slate-50 text-indigo-600 font-black py-4 rounded-2xl text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 border border-slate-100 shadow-sm active:scale-95 transition-all">
                          <LinkIcon size={14} /> Ảnh 1
                          </a>
                      </div>
                    ) : (
                      <div className="bg-slate-50 text-slate-300 rounded-2xl py-4 flex items-center justify-center border-2 border-dashed border-slate-100 text-[10px] font-black uppercase tracking-widest">Thiếu Ảnh 1</div>
                    )}

                    {(acceptance?.image2 || item.image2) ? (
                      <div className="space-y-3">
                          <a href={acceptance?.image2 || item.image2} target="_blank" rel="noreferrer" className="w-full bg-slate-50 text-indigo-600 font-black py-4 rounded-2xl text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 border border-slate-100 shadow-sm active:scale-95 transition-all">
                          <LinkIcon size={14} /> Ảnh 2
                          </a>
                      </div>
                    ) : (
                      <div className="bg-slate-50 text-slate-300 rounded-2xl py-4 flex items-center justify-center border-2 border-dashed border-slate-100 text-[10px] font-black uppercase tracking-widest">Thiếu Ảnh 2</div>
                    )}
                  </div>
              </div>
            </div>
